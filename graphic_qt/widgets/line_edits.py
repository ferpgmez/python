...
class Window(QWidget):
    def __init__(self):
        ...
        validatorLabel = QLabel("Validator:")
    ...
    def accessChanged(self, index):
        if index == 0:
            self.accessLineEdit.setEnabled(False)
        elif index == 1:
            self.accessLineEdit.setEnabled(True)
